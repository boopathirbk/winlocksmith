...
const Author: React.FC = () => {
    return (
        <div className="py-12 px-4 max-w-4xl mx-auto">
            <div className="bg-slate-900/80 border border-slate-800 rounded-2xl p-8 md:p-12 shadow-2xl">
                ...
                <div className="flex flex-col md:flex-row items-center gap-8 mb-12">
                    ...
                    <div className="text-center md:text-left space-y-4">
                        <h1 className="text-4xl font-bold text-white">Boopathi R</h1>
                        <p className="text-xl text-cyan-400 font-medium">Senior IT Support Executive & Web Developer</p>
                        <div className="flex flex-wrap justify-center md:justify-start gap-4 text-slate-400">
                            ...
                            <a href="mailto:boopathirbk77@gmail.com" className="flex items-center gap-2 hover:text-white transition-colors"><ICONS.Mail className="w-4 h-4" /> boopathirbk77@gmail.com</a>
                            <a href="tel:+917395845142" className="flex items-center gap-2 hover:text-white transition-colors"><ICONS.Phone className="w-4 h-4" /> +91 7395845142</a>
                        </div>
                ...
                <div className="space-y-10">
                    ...
                    <Section title="Education">
                        <div>
                            <h4 className="text-white font-semibold">Bachelor of Engineering in Computer Science</h4>
                            <p className="text-slate-400 text-sm">Bannari Amman Institute of Technology, Anna University | 2015 – 2019</p>
                        </div>
                    </Section>
...
const Section = ({ title, children }: { title: string, children: React.ReactNode }) => (
    <div className="space-y-4">
        <h3 className="text-xl font-bold text-white border-b border-slate-800 pb-2">{title}</h3>
        {children}
    </div>
);
...
const ExperienceItem = ({ role, company, period, location, children }: any) => (
    <div className="space-y-1">
        ...
        <p className="text-cyan-400 text-sm">{company} | {location}</p>
...
const SocialLink = ({ href, icon, label }: any) => (
    <a href={href} target="_blank" rel="noreferrer" className="flex items-center gap-2 px-3 py-1.5 bg-slate-800 hover:bg-slate-700 rounded-lg text-sm text-white transition-colors">
