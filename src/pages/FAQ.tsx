...
const FAQ_DATA: FAQItem[] = [
    ...
    // === USB & Device Control ===
    { q: "How does USB blocking work?", a: "It sets Deny_Read and Deny_Write policy values under the specific device class GUIDs for USB removable disks ({53f5630d-b6bf-11d0-94f2-00a0c91efb8b}) and WPD/MTP devices (Android phones). This is surgical — only USB flash drives, external HDDs, and phone file transfer are blocked. Internal drives (C:, D:), network shares, and the Downloads folder on the local disk are completely unaffected.", category: "USB & Devices" },
